...
//new solution
const somePlanets = ['Jupiter', 'Saturn', 'Uranus', 'Neptune']
let sumSatellites = 0;
for (let planet of somePlanets) {
    console.log(planet, system[planet]);
    sumSatellites += system[planet].satellites;
}
// old solution: const sumSatellites = system.Jupiter.satellites + system.Saturn.satellites + system.Uranus.satellites + system.Neptune.satellites;
