def show_title
    puts "Subway Travel Planner".center(80)
    puts "=-" * 40
end
...
def show_6_menu
    puts "Stations on this line: 'Grand Central', '33rd', '28th', '23rd', 'Union Square', 'Astor Place'"
end

def show_N_menu
    puts "Stations on this line: 'Times Square', '34th', '28th', '23rd', 'Union Square', '8th'"
end

def show_L_menu
    puts "Stations on this line: '8th', '6th', 'Union Square', '3rd', '1st'"
end
...
puts "What is your start line"
    ...
    if start_line == 'n'
        puts "You chose the N_Line"
        show_N_menu
    elsif start_line =='l'
        puts "You chose the L_Line"
        show_L_menu
    elsif start_line == '6'
        puts "You chose the 6_Line"
        show_6_menu
    else 
        puts "invalid selection"
        # not sure how to end this bit and make them start the input again
end
