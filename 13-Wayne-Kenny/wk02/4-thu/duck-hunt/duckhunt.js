...
const createDuck = function () {
    ...
    const flap = document.querySelector('.duck');

    setInterval(function () { flap.classList.toggle('flap') }, 250);

    setInterval(function () {
        flap.style.left = (Math.random() * window.innerWidth) + "px";
        flap.style.top = (Math.random() * window.innerHeight) + "px";
    }, 1000);
